...
public class Receptionist extends javax.swing.JFrame {
    ...
    private void rLoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rLoginBtnActionPerformed
        ...
        try {
            // String sql = "SELECT username, password FROM receptionist WHERE username=? AND password=?";
            
            prp = connection.prepareStatement("SELECT username, password FROM receptionist WHERE username=?", ResultSet.TYPE_SCROLL_INSENSITIVE, 
